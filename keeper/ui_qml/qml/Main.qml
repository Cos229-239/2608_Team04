        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle { Layout.preferredWidth: 1; Layout.preferredHeight: 34; color: border }
                    ColumnLayout {
                        spacing: 0
